...
| HD-002 | Report exports | Reporting | Report/export screens are demo-safe but do not yet provide complete backend aggregate/export endpoints. | Reviewers need repeatable procurement, finance, audit, integration, and closure reports. | Does not block Fabric proof; Fabric evidence can be verified through hash/audit endpoints first. | API DTOs, export endpoints, authorization tests, downloadable report E2E. | Open |
