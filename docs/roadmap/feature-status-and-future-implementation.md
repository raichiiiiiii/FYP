...
| Richer dashboard/procurement/finance summaries | implementation-required; partially scaffolded | Dashboard summary now returns backend-owned metrics, queues, blockers, readiness, and filtered legacy arrays using shared summary DTO contract helpers. Procurement and finance summary endpoints are not complete yet. | Add procurement and finance summary endpoints, replace remaining production aggregations, and test role filtering. |
