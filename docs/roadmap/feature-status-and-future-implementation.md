...
| Accessibility automation | implementation-required; partially scaffolded | Manual UI improvements exist. `@axe-core/playwright`, a reusable Playwright accessibility helper, `test:a11y`, a passing login smoke spec, and passing critical-route Playwright axe/focus coverage now exist. The automation fixed nested landmark, progressbar ARIA, graph landmark, muted-token contrast, and graph legend contrast defects. CI/evidence documentation remains incomplete. | Wire/document the command and record evidence. |
...
| Accessibility | Manual/shared UI improvements plus an axe-based Playwright helper, login smoke spec, and critical-route axe/focus regression coverage exist. | CI/report integration and evidence documentation remain incomplete. |
