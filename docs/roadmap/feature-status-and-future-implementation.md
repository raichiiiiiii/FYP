...
| Backup/restore | Deployment docs, backup/restore scope runbook, PostgreSQL backup script, restore script, and restore smoke script exist. | Evidence template is not complete; MinIO object backup automation remains future hardening. |
