...
| `corepack pnpm --dir apps/api test:unit -- fabric-governance node-status` | Fabric UAT blocker decision DTO, topology boundary, live-proof gate, and node-status decision summary. | Passed on 2026-06-07. | `docs/evidence/uat/FABRIC_UAT_BLOCKER_DECISIONS.md` |
| `corepack pnpm --dir apps/api test:integration -- fabric-governance node-status` | Authorization-gated Fabric UAT blocker decision endpoint and node-status decision metadata. | Passed on 2026-06-07. | `docs/evidence/uat/FABRIC_UAT_BLOCKER_DECISIONS.md` |
...
| `corepack pnpm --dir apps/api test:integration -- auth` | Auth config, dev-login guard, local seeded-password login, invitations, and OIDC test-provider behavior. | Passed on 2026-06-07; 15 tests passed. | `docs/evidence/uat/USE_CASE_BLOCKERS.md`; `docs/evidence/uat/auth-login-seeded-password.png` |
...
| `corepack pnpm test:e2e -- tests/e2e/09-auth-flow.spec.ts` | Local dev login, seeded local password login, and invitation acceptance browser flows. | Passed on 2026-06-07; 3 tests passed. | `docs/evidence/uat/auth-login-seeded-password.png` |
